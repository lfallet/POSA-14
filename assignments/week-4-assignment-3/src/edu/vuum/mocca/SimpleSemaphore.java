...
public class SimpleSemaphore {
     ...
     */
    // TODO - you fill in here
    private Condition noMorePermit;
    ...
    private AtomicInteger mAvailablePermitsCount;
    ...
    public SimpleSemaphore(int permits, boolean fair) {
        ...
        noMorePermit = mReentrantLock.newCondition();
        mAvailablePermitsCount = new AtomicInteger(permits);
    }
    ...
    public void acquireUninterruptibly() {
        ...
        try {
            while (mAvailablePermitsCount.get() == 0) {
                noMorePermit.awaitUninterruptibly();
            }
            mAvailablePermitsCount.decrementAndGet();
        } finally {
            mReentrantLock.unlock();
    ...
    public int availablePermits() {
    	...
    	return mAvailablePermitsCount.get();
    }
}
